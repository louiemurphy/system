...
function VincentDashboard() {
  ...
  const teamMember = "Vincent Go";  // Explicitly set team member for filtering
    ...
    <div className="dashboard-container">
      <div className="profile-sidebar">
        <div className="profile-image-container">
          <img className="profile-image" src="https://via.placeholder.com/150" alt="Vincent Go" />
        </div>
        <div className="profile-details">
          <h3>Vincent Go</h3>
          <p>vincent.go@mail.com</p>
        </div>
      </div>

      <div className="dashboard-content">
        <h1>Welcome, Vincent Go</h1>
        ...
        <div className="table-container">
          ...
          <table className="request-table">
            ...
            <tbody>
              {requests.length > 0 ? (
                requests
                  .filter(request => request.assignedTo === teamMember)  // Only show requests assigned to Vincent Go
                  .map((request) => (
